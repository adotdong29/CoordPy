...
* **`vision_mvp/wevra/__init__.py`** — re-exports
  ...
  alias); `SDK_VERSION` bumped to `wevra.sdk.v3.9`.
...
* **`docs/RESULTS_WEVRA_CROSS_ROLE_CORROBORATION.md`** *(this file)*.
...
```text
$ python3 -m unittest -v vision_mvp.tests.test_wevra_cross_role_corroboration
