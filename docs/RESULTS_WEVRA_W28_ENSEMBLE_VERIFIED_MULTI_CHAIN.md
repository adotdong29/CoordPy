# RESULTS — Wevra SDK v3.29 / W28 (ensemble-verified cross-model multi-chain pivot ratification)
...
important property (named in `RESULTS_WEVRA_W27_MULTI_CHAIN_PIVOT.md`):
...
* `vision_mvp/wevra/team_coord.py` — appended ~700 lines: W28
...
* `vision_mvp/wevra/__init__.py` — added W28 exports under `__all__`,
  added `__experimental__` tuple listing every dense-control symbol
  (W22..W28), bumped `SDK_VERSION` to `wevra.sdk.v3.29`.
...
* `docs/RESULTS_WEVRA_W28_ENSEMBLE_VERIFIED_MULTI_CHAIN.md` —
  this file.
...
* Wider focused regression: `pytest vision_mvp/tests/test_wevra_*
