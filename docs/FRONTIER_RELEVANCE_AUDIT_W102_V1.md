...
| **Base MBPP at K=5 same-budget at 70B for retirement** | W91 + W101 V1 loader scratch run | UNCHANGED — capped via ceiling saturation.  The W102 V2 cheap pilot tests whether MBPP+'s extra-test surface relieves this cap empirically. |
