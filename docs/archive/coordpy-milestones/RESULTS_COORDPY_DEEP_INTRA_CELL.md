...
> `vision_mvp/coordpy/capsule.py` (PARSE_OUTCOME),
...
> `vision_mvp/tests/test_coordpy_capsule_native_deeper.py` (18 tests).
...
**Code anchor.** `vision_mvp/coordpy/lifecycle_audit.py`;
`vision_mvp/tests/test_coordpy_capsule_native_deeper.py
::LifecycleAuditTests`.
...
## What this changes about CoordPy's originality and publishability
...
- CoordPy is **not** "fully capsule-native". The parser axis is
...
- Deterministic mode is **not** "CoordPy runs are reproducible".
...
- W3-39 / W3-40 / W3-41 are **proved** (proofs by inspection of
  ...
  tests passing in `test_coordpy_capsule_native_deeper.py`).

## Empirical anchor (this milestone)

| Metric                                                | Value                              |
| ----------------------------------------------------- | ---------------------------------- |
| New SDK v3.3 contract tests                            | 18 (in `test_coordpy_capsule_native_deeper.py`) |
| Total `vision_mvp.tests.test_coordpy_*` + `test_capsule_*` passing | 165                                |
