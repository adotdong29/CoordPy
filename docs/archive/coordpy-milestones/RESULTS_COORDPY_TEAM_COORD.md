...
The capsule layer was previously load-bearing inside *one* CoordPy
...
* The `TEAM_HANDOFF` / `ROLE_VIEW` / `TEAM_DECISION` capsule kinds
  ship in the SDK's closed vocabulary, but the **CoordPy product
...
python -m pytest vision_mvp/tests/test_coordpy_team_coord.py -v
```
...
* Tests: [`vision_mvp/tests/test_coordpy_team_coord.py`](../vision_mvp/tests/test_coordpy_team_coord.py)
* Code: [`vision_mvp/coordpy/team_coord.py`](../vision_mvp/coordpy/team_coord.py),
  [`vision_mvp/coordpy/team_policy.py`](../vision_mvp/coordpy/team_policy.py),
  [`vision_mvp/experiments/phase52_team_coord.py`](../vision_mvp/experiments/phase52_team_coord.py)
