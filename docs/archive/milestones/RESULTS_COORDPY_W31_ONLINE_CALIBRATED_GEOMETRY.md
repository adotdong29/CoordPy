...
| **H9** | Release-readiness clause | **PASS** — SDK_VERSION bumped to `coordpy.sdk.v3.32`, `__experimental__` updated with W31 symbols, pyproject.toml 0.5.5, CHANGELOG entry added. |
| **H10** | Focused regression green | **PASS** — 41/41 W31 unit tests + 437/437 phase69-78 tests + 68/68 coordpy_team_coord/runtime/public_api/extensions/provenance tests pass. |
...
* **MODIFIED**: `vision_mvp/coordpy/team_coord.py` — appended ~750
...
* **MODIFIED**: `vision_mvp/coordpy/__init__.py` — added W31 exports
  under `__all__`, added W31 entries to `__experimental__`, bumped
  `SDK_VERSION` to `coordpy.sdk.v3.32`.
...
* **NEW**: `docs/RESULTS_COORDPY_W31_ONLINE_CALIBRATED_GEOMETRY.md` —
  this file.
...
* `pytest vision_mvp/tests/test_coordpy_team_coord +
  ...
  test_coordpy_provenance` — **68/68 PASS** in 23s.
