...
from coordpy._internal.core.dynamic_comm import (
    DynamicCommRouter,
...
from coordpy._internal.tasks.contested_incident import (
...
from coordpy._internal.tasks.incident_triage import (
...
def run_nested_two_round_adaptive_sub(
    ...
    Round 2:
      ...
      9. Tick → edges expire.
    """
    from coordpy._internal.core.adaptive_sub import (
