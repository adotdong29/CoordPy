"""Contract tests for the Wevra unified runtime (Slice 2).
...
class SweepSpecTests(unittest.TestCase):
    ...
    def test_sweepspec_is_frozen(self):
        from vision_mvp.wevra import SweepSpec
...
class MockRunSweepTests(unittest.TestCase):
    ...
    def test_mock_run_sweep_returns_v2_schema(self):
        from vision_mvp.wevra import SweepSpec, run_sweep
        spec = SweepSpec(
            ...
            n_instances=4)
        sw = run_sweep(spec)
        self.assertEqual(sw["schema"], "wevra.sweep.v2")
...
class RunnerV2ReportTests(unittest.TestCase):
    ...
    def test_runner_emits_v2_schema(self):
        from vision_mvp.wevra import RunSpec, run, PRODUCT_REPORT_SCHEMA
        ...
        self.assertEqual(rep["sweep"]["schema"], "wevra.sweep.v2")
