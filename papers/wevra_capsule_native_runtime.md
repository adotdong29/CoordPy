...
cross-boundary object in a Wevra run satisfies the *same* contract,
...
- *"Wevra makes LLM agent runs deterministic."* **Mis-reading.**
...
- *"Theorem W3-41 means every Wevra run produces the same CID."*
...
## 8. What this changes about Wevra's originality claim
...
- Capsule contract: `vision_mvp/wevra/capsule.py`
- Capsule-native runtime: `vision_mvp/wevra/capsule_runtime.py`,
